...
import (
	...
	"github.com/aliworkshop/terra-sdk/testutil/rest"
	...
	authtest "github.com/aliworkshop/terra-sdk/x/auth/client/testutil"
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			if tc.expErr {
				...
				// ref: https://github.com/aliworkshop/terra-sdk/issues/8680
				// ref: https://github.com/aliworkshop/terra-sdk/issues/8681
