...
Currently, KVStore data can be remotely accessed through [Queries](https://github.com/aliworkshop/terra-sdk/blob/master/docs/building-modules/messages-and-queries.md#queries)
