...
HTTPS_GIT := https://github.com/aliworkshop/terra-sdk.git
...
ifeq ($(LEDGER_ENABLED),true)
  ifeq ($(OS),Windows_NT)
    ...
    ifeq ($(UNAME_S),OpenBSD)
      $(warning OpenBSD detected, disabling ledger support (https://github.com/aliworkshop/terra-sdk/issues/1988))
    else
...
ldflags = -X github.com/aliworkshop/terra-sdk/version.Name=sim \
		  -X github.com/aliworkshop/terra-sdk/version.AppName=simd \
		  -X github.com/aliworkshop/terra-sdk/version.Version=$(VERSION) \
		  -X github.com/aliworkshop/terra-sdk/version.Commit=$(COMMIT) \
		  -X "github.com/aliworkshop/terra-sdk/version.BuildTags=$(build_tags_comma_sep)" \
...
ifeq (cleveldb,$(findstring cleveldb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/aliworkshop/terra-sdk/types.DBBackend=cleveldb
endif
ifeq (badgerdb,$(findstring badgerdb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/aliworkshop/terra-sdk/types.DBBackend=badgerdb
  BUILD_TAGS += badgerdb
endif
# handle rocksdb
ifeq (rocksdb,$(findstring rocksdb,$(COSMOS_BUILD_OPTIONS)))
  ...
  CGO_ENABLED=1
  BUILD_TAGS += rocksdb
  ldflags += -X github.com/aliworkshop/terra-sdk/types.DBBackend=rocksdb
endif
# handle boltdb
ifeq (boltdb,$(findstring boltdb,$(COSMOS_BUILD_OPTIONS)))
  BUILD_TAGS += boltdb
  ldflags += -X github.com/aliworkshop/terra-sdk/types.DBBackend=boltdb
endif
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/aliworkshop/terra-sdk/types"
	godoc -http=:6060
...
format:
	...
	find . -name '*.go' -type f -not -path "./vendor*" -not -path "*.git*" -not -path "./client/docs/statik/statik.go" -not -path "./tests/mocks/*" -not -name '*.pb.go' | xargs goimports -w -local github.com/aliworkshop/terra-sdk
.PHONY: format
...
devdoc-init:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/aliworkshop/terra-sdk" -w "/go/src/github.com/aliworkshop/terra-sdk" tendermint/devdoc echo
	# TODO make this safer
	$(call DEVDOC_SAVE)

devdoc:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/aliworkshop/terra-sdk" -w "/go/src/github.com/aliworkshop/terra-sdk" devdoc:local bash
